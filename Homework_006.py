# 1. С помощью использования **лямбд, filter, map, zip, enumerate, list comprehension
...
# lst = [sum(i in 'уеыаоэяию' for i in lin)
#  for lin in lines]
...
# 2. Напишите функцию print_operation_table(operation, num_rows=6, num_columns=6), которая принимает в качестве аргумента функцию, 
...
# 3. Напишите функцию same_by(characteristic, objects), 
